#define _IOL_PROGRAM_TITLE "OOP344 20121 CIO tester R 0.92"
...
/*
   ...
   This tester program is to be compiled with bconsole.h and bconsole.c to test your cio functions.
   ...
   OTHER THAN SETTING THE VALUES OF "TEAM_NAME" AND "RELEASE_VERSION" DO NOT MODIFY
   THIS FILE IF THIS IS THE FINAL TEST FOR SUBMISSION.
...
#define TEAM_NAME "MY NAME"   /* your name as written on your student card will go here. (no nick-names) */
#define RELEASE_VERSION "R0.92"
...
int test5(){
  ...
  do{
    ...
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 10: console.edit() General Test, Test console.edit anyway you can and make sure it does not crash.  "
                            "Press F5 to toggle IsTextEdirot, press F6 to toggle ReadOnly. " );
    PrnBox(10, 29, 22, 3);
    bio_printf(9, 28, -1, "TextEdtor: %d, ReadOnly: %d       ", isTextEditor, readonly);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, isTextEditor, readonly);
    (key == F(5)) && (isTextEditor = !isTextEditor);
    (key == F(6)) && (readonly = !readonly);
    if(key != F(5) && key != F(6)){
      bio_printf(13, 5, -1, "console.edit() returned %s, %s", keyname(key), keycode(key));
      bio_printf(14, 5, -1, "Curpos: %d, insert: %d, offset: %d, TextEdtor: %d, ReadOnly: %d       ",curpos, insert, offset, isTextEditor, readonly);
      bio_printf(16, 5, -1, "Str value after edit:");
...
void displayText(int from, int offset, char test[][61]){
  int i;
  for(i=from;i<from+10 && i<20;i++){
    if(from + offset >= StrLen(test[i]))
      console.display("", 10 + i- from, 10, 20);
    else
      console.display(&test[i][from]+offset ,10 + i- from, 10, 20);
  }
  for(;i<from+10;i++){
    console.display("", 10 + i- from, 10, 20);
  }
...
int CheckIoEditVals(int curposShouldBe, int curposIs, int insertShouldBe, int insertIs, int offsetShouldBe, int offsetIs){
  ...
  if(!ok){
    bio_printf(15, 5, -1, "- console.edit() was supposed to have the following values but it doesn't:");
  }
  return ok;
}
int CheckIoEditMinMax(int curmin, int curmax, int curposIs, int insertShouldBe, int insertIs, int offmin, int offmax, int offsetIs){
...
int CheckReturnedKey(int KeyShouldBe, int KeyIs){
  ...
  if(KeyShouldBe != KeyIs){
    bio_printf(13, 5, -1, "- console.edit() was supposed to return %s, %s", keyname(KeyShouldBe), keycode(KeyShouldBe));
...
int CheckStrValue(const char* strShoulBe, const char* strIs){
  ...
  if(diff){
    bio_printf(19, 5, -1, "- console.edit() does not have correct value for its data:");
...
int test4(){
  ...
  if(runtest(4)){
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.1: console.edit() initial corrections, Curpos: The curpos is set to 40 that is invalid and it should be corrected to 19. "
                            "HIT ENTER ONLY to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, 0, 0);
  ...
  if(ok && runtest(6)){
    ...
    curpos = 10;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.3: console.edit() initial corrections, Curpos: The curpos is set to 10 that is invalid and it should be corrected to 5. "
                            "HIT ENTER ONLY to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(7)){
    ...
    insert = 1;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.4: console.edit() toggling insert: The insert is set to 1, hit insert key once and then hit ENTER only to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, 0, 0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(8)){
    ...
    insert = 1;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.5: console.edit() deleting chars : Hit Del key twice and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(9)){
    ...
    insert = 1;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.6: console.edit() inserting chars in insert mode : Hit 'a', 'b' and 'c' and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 22,&insert, &offset, &curpos, 0, 0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(10)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.7: console.edit() inserting chars in overstrike mode : Hit 'a', 'b' and 'c' and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 20,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(11)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.8: console.edit() Home key : Hit Home key and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
    ok = CheckIoEditVals(0, curpos, 0, insert, 0, offset) && ok;
    ok = CheckStrValue("ABCDEFGHIJKLMNOPQRSTUVWXY", str) && ok;
    pause(ok);
  ...
  if(ok && runtest(12)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.9: console.edit() End key : Hit END and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(13)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.10: console.edit() End key : Hit END and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(14)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.11: console.edit() Scrolling right : Hit left Arrow 4 times and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(15)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.12: console.edit() Scrolling right : Hit left Arrow 4 times and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(16)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.13: console.edit() Scrolling left : Hit right Arrow 4 times and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(17)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.14: console.edit() Scrolling left : Hit right Arrow 6 times and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0,0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(18)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.15: console.edit() Backspace : Hit backspace  and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0, 0);
    ok = CheckReturnedKey(ENTER, key);
  ...
  if(ok && runtest(19)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.16: console.edit() Backspace : Hit Backspace 4 times and then hit ENTER to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0, 0);
    ok = CheckReturnedKey(ENTER, key);
    ok = CheckIoEditMinMax(0,10, curpos, 0, insert,0,9, offset) && ok;
  ...
  if(ok && runtest(20)){
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4 (continued), console.edit() IsTextEditor set to true. Press any key to continue:");
    console.pause();
  }
#endif
  ...
  if(ok && runtest(21)){
    ...
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 60,&insert, &offset, &curpos, 1,0);
  ...
  if(ok  && runtest(22)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.18: console.edit() Home key : Hit Home key to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1,0);
    ok = CheckReturnedKey(0, key);
    ok = CheckIoEditVals(0, curpos, 0, insert, 0, offset) && ok;
    ok = CheckStrValue("ABCDEFGHIJKLMNOPQRSTUVWXY", str) && ok;
    pause(ok);
  ...
  if(ok && runtest(23)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.19: console.edit() End key : Hit END  to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1 ,0);
    ok = CheckReturnedKey(0, key);
    ok = CheckIoEditVals(19, curpos, 0, insert, 6, offset) && ok;
  ...
  if(ok && runtest(24)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.20: console.edit() Scrolling right : Hit left Arrow 4 times (but stop if fucntion exits) to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1, 0);
    ok = CheckReturnedKey(0 , key);
    ok = CheckIoEditMinMax(0,CIO_TABSIZE, curpos, 0, insert,20-CIO_TABSIZE,20, offset) && ok;
    ok = CheckStrValue("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrs", str) && ok;
    pause(ok);
  }
#endif
  ...
  if(ok && runtest(25)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.21: console.edit() Scrolling left : Hit right Arrow 4 times (but stop if fucntion exits) to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1 ,0);
    ok = CheckReturnedKey(0, key);
    ok = CheckIoEditMinMax(19-CIO_TABSIZE,19, curpos, 0, insert,10,10+CIO_TABSIZE, offset) && ok;
    ok = CheckStrValue("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrs", str) && ok;
    pause(ok);
  }
#endif
  ...
  if(ok && runtest(26)){
    ...
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.22: console.edit() Backspace : Hit Backspace 4 times (but stop if fucntion exits) to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1 ,0);
    ok = CheckReturnedKey(0, key);
    ok = CheckIoEditMinMax(0,CIO_TABSIZE, curpos, 0, insert,10 - CIO_TABSIZE ,10, offset) && ok;
  ...
  if(ok && runtest(27)){
    ...
    insert = 1;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.23: console.edit() Escape when IsTextEditor = 0, hit HOME key, then 'a', 'b', 'c' and then ESCAPE to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 0, 0);
  ...
  if(ok  && runtest(28)){
    ...
    insert = 0;
    cls();
    PrnTextBox(1, 5, 70, 8, "Test 4.24: console.edit() Escape when IsTextEditor = 1 , hit right arrow 2 times, then 'a', 'b', 'c' and then ESCAPE to test!");
    PrnBox(10, 29, 22, 3);
    key = console.edit(str,11,30, 20, 50,&insert, &offset, &curpos, 1, 0);
    ok = CheckReturnedKey(ESCAPE, key);
    ok = CheckIoEditVals(15, curpos, 0, insert,10, offset) && ok;
...
int test3(){
  ...
  cls();
  PrnTextBox(1,10,50,5, "Test 3: Testing console.display(): make sure all the A:(your console.display) "
                        "fields match exactly thier corresponding B:(Tester display) fields;");
  bio_printf(8, 6, -1, "A:");
  PrnBox(7,10, 12, 3);
  console.display(str, 8, 11, 10);
  bio_printf(11, 6, -1, "B:");
  PrnBox(10, 10, 12, 3);
